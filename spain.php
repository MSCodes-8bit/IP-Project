...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/responsive.css">
	<link rel="stylesheet" href="css/spain.css">
...
<body>
    ...
    <div class="nav-logo-cont"><span class="nav-logo" id="nav-logo">spain</span></div>
  ...
  function nav() {
	...
	function menu_open() {
  	...
  	function dataFeedPlace () {
  		...
  		request.open("get", "data/place-spain.json");
  		request.onload = () => {
  			try {
    ...
    // redirect(clicked_id);
  	...
  	function populatePlace(json) {
  		...
  		for (var i = 0; i < json.length; i++) {
  			...
  			document.getElementById("place-img-"+i).style.background = "url('img/spain/"+json[i][1]+"/" + json[i][0] + "') no-repeat";
