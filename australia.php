...
<body>
    ...
    <div class="nav-logo-cont"><span class="nav-logo" id="nav-logo">australia</span></div>
  ...
  function nav() {
	...
	function menu_open() {
  	...
  	function dataFeedPlace () {
  		...
  		request.open("get", "data/place-australia.json");
  		request.onload = () => {
  			try {
    ...
    // document.body.scrollTop = a;
      ...
      setTimeout(function(){window.location.href = ""+path+"/place.html";}, 2000);
      	...
      	document.cookie = 'country=australia';
    ...
    // redirect(clicked_id);
  	...
  	function populatePlace(json) {
  		...
  		for (var i = 0; i < json.length; i++) {
  			...
  			document.getElementById("place-img-"+i).style.background = "url('img/australia/"+json[i][1]+"/" + json[i][0] + "') no-repeat";
