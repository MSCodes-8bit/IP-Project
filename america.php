...
<body>
    ...
    <div class="nav-logo-cont"><span class="nav-logo" id="nav-logo">america</span></div>
...
<script type="text/javascript">
  ...
  function nav() {
    ...
    // document.body.scrollTop = a;
      ...
      document.cookie = 'country=america';
    ...
    // redirect(clicked_id);
  	...
  	function populatePlace(json) {
  		...
  		for (var i = 0; i < json.length; i++) {
  			...
  			document.getElementById("place-img-"+i).style.background = "url('img/america/"+json[i][1]+"/"+json[i][0]+"') no-repeat";
